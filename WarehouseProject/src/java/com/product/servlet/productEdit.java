    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			System.out.println("pro_stock = " + stockStr);
                        System.out.println("pro_id = " + proidStr);
...
//                                                                String mimeType = part.getContentType();
                                ...
                                request.setAttribute("SuccessMsg", "Products Edited Successfully");
                                request.getRequestDispatcher("Product/viewproducts.jsp").forward(request, response);
			}else {
