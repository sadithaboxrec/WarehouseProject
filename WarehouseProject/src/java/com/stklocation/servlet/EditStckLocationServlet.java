 ...
 * @author DELL
 */
@WebServlet(name = "EditStckLocationServlet", urlPatterns = {"/editstcklocation"})
public class EditStckLocationServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditStckLocationServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditStckLocationServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            boolean f = dao.updateEditLocation(loc);

            if (f) {
                request.setAttribute("SuccessMsg", "Category Mod Successfully");
